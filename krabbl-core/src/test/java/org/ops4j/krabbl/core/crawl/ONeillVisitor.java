...
public class ONeillVisitor implements PageVisitor {

    private static Logger log = LoggerFactory.getLogger(ONeillVisitor.class);
    private File outputDir;


    public ONeillVisitor(File outputDir) {
