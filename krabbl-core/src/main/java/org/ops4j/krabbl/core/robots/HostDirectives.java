...
public class HostDirectives {
    ...
    private static final long EXPIRATION_DELAY = TimeUnit.DAYS.toMillis(1);
    ...
    private RobotsConfiguration config;
    private String userAgent;

    public HostDirectives(RobotsConfiguration configuration) {
    ...
    /**
     * Change the user agent string used to crawl after initialization. This will reorder (recreate)
     * the list of user agent directives for this host.
     *
     * @param userAgent
     ...
     *
     * @param directives
     *            The set of directives to add to this host
     */
