...
public class PathRule {
    ...
    /**
     * Match a pattern defined in a robots.txt file to a path Following the pattern definition as
     * stated on: https://support.google.com/webmasters/answer/6062596?hl=en&ref_topic=6061961
     *
     * This page defines the following items: * matches any sequence of characters, including / $
     ...
     * @param path
     *            The path to match with the pattern
     ...
     *
     * @param type
     *            Either HostDirectives.ALLOWS or HostDirectives.DISALLOWS
     * @param pattern
     ...
     *
     * @param path
     *            The path to match with this pattern
